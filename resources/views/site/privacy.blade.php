        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-container">
                                <form id="privacyForm" data-toggle="validator" data-focus="false">
                                    ...
                                    <div class="form-group checkbox">
                                        <input type="checkbox" id="pterms" value="Agreed-to-Terms" required>I have read and agree to Our <a href="/privacy-policy">Privacy Policy</a> and <a href="/terms">Terms Conditions</a>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <a class="btn-outline-reg back" href="/">BACK</a>
                </div> <!-- end of col-->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
